...
/* Small inline star path for rating */
  ...
  return (
    <main className="bg-white text-zinc-900">
      ...
      <header className="border-b border-zinc-200">
        <div className="mx-auto flex max-w-[1200px] items-center justify-between gap-4 px-4 py-4 sm:px-5">
      ...
      <section className="relative w-full bg-[#F2F0F1]">
        {/* Decorative stars (Figma vector positions) */}
        <Image
          src={ASSETS.star}
          alt=""
          width={56}
          height={56}
          className="absolute left-[52.08%] top-[30.5%]"
          aria-hidden
        />
        <Image
          src={ASSETS.star}
          ...
          width={104}
          height={104}
          className="absolute left-[82%] top-[15.03%]"
          aria-hidden
        />
        <div className="mx-auto max-w-[1200px] grid grid-cols-[1.1fr_0.9fr] items-center gap-0 px-4 sm:px-5" style={{ minHeight: 663 }}>
          {/* Left text column */}
          <div className="pl-[72px] pr-6 py-12">
            <h1 className="max-w-[600px] text-[64px] font-extrabold leading-[64px] text-black" style={{ fontFamily: "var(--font-integral), sans-serif" }}>
              FIND CLOTHES THAT MATCHES YOUR STYLE
            </h1>

            <p className="mt-6 max-w-[600px] text-[16px] leading-[22px] text-black/60" style={{ fontFamily: "var(--font-satoshi), sans-serif" }}>
              Browse through our diverse range of meticulously crafted garments, designed to bring out your individuality and cater to your sense of style.
            </p>

            <Link href="/category" className="mt-8 inline-flex items-center rounded-[62px] bg-black px-12 py-4 text-white" style={{ fontFamily: "var(--font-satoshi), sans-serif" }}>
              Shop Now
            </Link>

            <div className="mt-10 grid max-w-[545px] grid-cols-3 gap-6">
              <div>
                <div className="text-2xl font-bold">200+</div>
                <div className="text-sm text-black/60">International Brands</div>
              </div>
              <div>
                <div className="text-2xl font-bold">2,000+</div>
                <div className="text-sm text-black/60">High-Quality Products</div>
              </div>
              <div>
                <div className="text-2xl font-bold">30,000+</div>
                <div className="text-sm text-black/60">Happy Customers</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-end pr-[40px]">
            <div className="relative w-[520px] h-[520px] md:w-[520px] md:h-[560px]">
              <Image
                src={ASSETS.hero}
                alt="Hero"
                fill
      ...
      <section className="bg-black py-6">
        <div className="mx-auto max-w-[1200px] flex items-center justify-between gap-6 px-4 sm:px-5">
          <Image src={ASSETS.brands.versace} alt="versace" width={140} height={32} />
          <Image src={ASSETS.brands.zara} alt="zara" width={120} height={36} />
          <Image src={ASSETS.brands.gucci} alt="gucci" width={156} height={36} />
          <Image src={ASSETS.brands.prada} alt="prada" width={194} height={32} />
          <Image src={ASSETS.brands.calvin} alt="calvin" width={160} height={32} />
        </div>
      </section>
      ...
      <section className="mx-auto max-w-[1200px] px-4 py-12 sm:px-5">
        <h2
          className="mb-8 text-center text-[48px] font-bold leading-[58px] text-black"
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {newArrivals.map((p, i) => {
            ...
            return (
            <article key={p.id ?? `${p.title}-${i}`} className="rounded-2xl border border-zinc-200 bg-white overflow-hidden">
        ...
        <div className="mt-8 flex justify-center">
          <button className="rounded-full border border-black px-6 py-2 text-sm">View All</button>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-[1200px] px-4 pb-12 pt-12 sm:px-5">
        <div className="rounded-3xl bg-zinc-100 px-6 pb-6 pt-10 sm:px-8">
          <h2
            className="mb-6 text-center text-[48px] font-bold leading-[58px] text-black"
            style={{ fontFamily: "var(--font-integral), sans-serif" }}
          >
            BROWSE BY DRESS STYLE
          </h2>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="relative h-[220px] overflow-hidden rounded-2xl bg-white">
              <Image src={ASSETS.dress.causal} alt="Casual" fill className="object-cover" />
      ...
      <section className="mx-auto max-w-[1200px] px-4 pb-12 sm:px-5">
        <div className="mb-6 flex items-center justify-between">
          <h2
            className="text-[48px] font-bold leading-[58px] text-black"
            style={{ fontFamily: "var(--font-integral), sans-serif" }}
          >
            OUR HAPPY CUSTOMERS
          </h2>
        ...
        <div className="relative overflow-hidden">
          <div
            ...
            style={{
              transform: `translateX(calc(50% - ${testimonialIndex * 336 + 480}px))`,
            }}
          >
